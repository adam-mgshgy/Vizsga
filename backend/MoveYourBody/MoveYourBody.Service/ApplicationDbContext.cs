    ...
    public class ApplicationDbContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Training>().HasData(
                new Training() { Id = 1, Category_id = 1, Contact_phone = "+36701234567", Description = "Szeretettel vár Józsi Edző a legnépszerűbb box edzésén! Kezdőket és haladókat is szívesen fogadunk. Nem kell más, csak egy törölköző, víz, és hatalmas lelkesedés!", Name = "Box Józsival", Trainer_id = 1 },
                new Training() { Id = 2, Category_id = 2, Contact_phone = "+36701234567", Description = "Gyere Crossfit edzésre Józsi edzővel, ha szeretnél fitt lenni!", Name = "Józsi Crossfit", Trainer_id = 1, Index_image_id = 1 },
                new Training() { Id = 3, Category_id = 3, Contact_phone = "+36701234566", Description = "Fociedzés Bélával, gyertek sokan", Name = "Fociedzés", Trainer_id = 2 },
                new Training() { Id = 4, Category_id = 4, Contact_phone = "+36701234566", Description = "Kosarazzunk együtt!", Name = "Kosár Bélával", Trainer_id = 2 },
                new Training() { Id = 5, Category_id = 5, Contact_phone = "+36701234565", Description = "Géza Edző kézilabda edzése", Name = "Gézi Kézi", Trainer_id = 3 },
                new Training() { Id = 6, Category_id = 12, Contact_phone = "+36701234565", Description = "Jóga Gézával", Name = "Jóga edzés", Trainer_id = 3 },
                new Training() { Id = 7, Category_id = 2, Contact_phone = "+36701234565", Description = "Géza Crossfit edzése", Name = "GézaFitt", Trainer_id = 3 }
                );
            modelBuilder.Entity<TrainingSession>().HasData(
                new TrainingSession() { Address_name = "Virág utca 8.", Date = new DateTime(2022,4,10,12,30, 0), Id = 1, Location_id = 58, Max_member = 10, Min_member = 5, Minutes = 45, Number_of_applicants = 5, Place_name = "Sportközpont", Price = 1500, Training_id = 1 },
                ...
                new TrainingSession() { Address_name = "Virág utca 5.", Date = new DateTime(2022,3,28,12,30, 0), Id = 3, Location_id = 59, Max_member = 10, Min_member = 2, Minutes = 45, Number_of_applicants = 2, Place_name = "Sportközpont", Price = 1500, Training_id = 1 },
                ...
                new TrainingSession() { Address_name = "Virág utca 7.", Date = new DateTime(2022,5,10,12,30, 0), Id = 5, Location_id = 60, Max_member = 10, Min_member = 5, Minutes = 45, Number_of_applicants = 1, Place_name = "Sportközpont", Price = 1500, Training_id = 2 },
                new TrainingSession() { Address_name = "Virág utca 8.", Date = new DateTime(2022,3,30,12,30, 0), Id = 6, Location_id = 59, Max_member = 4, Min_member = 1, Minutes = 45, Number_of_applicants = 1, Place_name = "Sportközpont", Price = 1500, Training_id = 3 },
                new TrainingSession() { Address_name = "Virág utca 10.", Date = new DateTime(2022,3,29,10,30, 0), Id = 7, Location_id = 58, Max_member = 10, Min_member = 5, Minutes = 45, Number_of_applicants = 2, Place_name = "Sportközpont", Price = 1500, Training_id = 4 },
                ...
                new TrainingSession() { Address_name = "Virág utca 2.", Date = new DateTime(2022,4,20,12,30, 0), Id = 9, Location_id = 60, Max_member = 10, Min_member = 6, Minutes = 45, Number_of_applicants = 0, Place_name = "Sportközpont", Price = 1500, Training_id = 6 },
                new TrainingSession() { Address_name = "Virág utca 3.", Date = new DateTime(2022,6,10,12,30, 0), Id = 10, Location_id = 60, Max_member = 10, Min_member = 5, Minutes = 45, Number_of_applicants = 1, Place_name = "Sportközpont", Price = 1500, Training_id = 7 },
                new TrainingSession() { Address_name = "Virág utca 8.", Date = new DateTime(2022,5,10,12,0,0), Id = 11, Location_id = 61, Max_member = 10, Min_member = 5, Minutes = 45, Number_of_applicants = 1, Place_name = "Sportközpont", Price = 1500, Training_id = 7 }
                );
