...
-- Script date 2021.11.18 9:35:53
...
--
ALTER TABLE user 
  ADD CONSTRAINT FK_user_city_id FOREIGN KEY (county_id)
...
--
-- Table moveyourbody.county does not contain any data (it is empty)
